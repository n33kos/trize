...
| config.graph | [<code>Graph</code>](#Graph) | The graph class the function eill be drawn on |
...
| config.points | [<code>Array.&lt;Vector2&gt;</code>](#Vector2) | An array of Vector2 objects to draw a curve through |
